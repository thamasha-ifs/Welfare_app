...
namespace Welfare_App.Services
{
    public class ReportingService
    {
        ...
        {
            //    var resultList = await (from info in _context.EmployeeInfoForTrip
            ...
            //    //("{0}, {1}, {2}, {3}, {4}, {5}, {6}, {7}, {8}", result.EmpNo, result.Fname, result.Lname, result.Designation, result.Spouse, result.ChildernCount, result.Transport,
